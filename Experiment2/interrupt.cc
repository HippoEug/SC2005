...
/* Experiment 2 */
/* Add code to remove pending interrupt from head of pending list. */å
//----------------------------------------------------------------------
// Interrupt::InterruptRemove
// 	Function added for Experiment 2
//	Remove all the pending interrupts from the pending list
//----------------------------------------------------------------------
void
Interrupt::InterruptRemove()
{
   pending->Remove();
   printf("Thread Finished. Removing pending interrupts from the list\n");
}
